...
#
# Generated by export_simulation on Sun Jul 26 16:35:32 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_HDMI_0.sh' script.

./Driver_HDMI_0.sh -reset_run
...
./Driver_HDMI_0.sh -noclean_files

For more information on the script, please type './Driver_HDMI_0.sh -help'.
